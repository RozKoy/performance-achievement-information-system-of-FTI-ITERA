...
<x-super-admin-template title="Tambah Organisasi - Super Admin">
    ...
    <form action="" class="flex flex-col gap-2">
        ...
        <button type="submit" title="Tombol tambah" class="ml-auto flex items-center gap-1 rounded-lg bg-green-500 px-2.5 py-2 text-center text-xs text-white hover:bg-opacity-90 focus:outline-none focus:ring-2 focus:ring-green-600 max-sm:w-fit sm:text-sm">
