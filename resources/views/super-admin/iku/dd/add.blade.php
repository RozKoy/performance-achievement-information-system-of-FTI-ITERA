...
@endphp
<x-super-admin-template title="Tambah Data Dukung - Super Admin">
    <x-partials.breadcrumbs.default :$breadCrumbs />
    <x-partials.heading.h2 text="tambah data dukung" previousRoute="{{ route('super-admin-iku-dd', ['sk' => 'hahahah', 'ikk' => 'hahaha']) }}" />
