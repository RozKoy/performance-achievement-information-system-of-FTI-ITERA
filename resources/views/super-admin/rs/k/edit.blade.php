...
<x-super-admin-template title="Ubah Kegiatan - Super Admin">
    ...
    <x-partials.heading.h2 text="ubah kegiatan" previousRoute="{{ route('super-admin-rs-k', ['ss' => $ss['id']]) }}" />
    ...
    <form action="" method="POST" class="flex flex-col gap-2">
        ...
        <div class="flex flex-wrap gap-2">
            ...
            <div class="flex flex-1 flex-col gap-2">
                ...
                <x-partials.input.text name="name" title="Kegiatan" value="{{ old('name') ? old('name') : $k['name'] }}" autofocus required />
            </div>
        </div>
