...
<x-super-admin-template title="Ubah Indikator Kinerja - Super Admin">
    ...
    <x-partials.heading.h2 text="ubah indikator kinerja" previousRoute="{{ route('super-admin-rs-ik', ['ss' => 'hahahah', 'k' => 'hahaha']) }}" />
    ...
    <form action="" class="flex flex-col gap-2">
        <div class="flex flex-wrap gap-2">
            ...
            <div class="flex flex-1 flex-col gap-2">
                ...
                <x-partials.input.text name="name" title="Indikator kinerja" autofocus required />
            </div>
