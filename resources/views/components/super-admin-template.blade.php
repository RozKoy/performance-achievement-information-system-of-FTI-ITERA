        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="{{ url(route('dashboard-super-admin')) }}" title="Halaman beranda" class="group/logo ms-2 flex md:me-24">
    ...
    <aside id="logo-sidebar" class="fixed left-0 top-0 z-40 h-screen w-72 -translate-x-full bg-white pt-16 text-base transition-transform sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full divide-y-2 divide-primary overflow-y-auto bg-white px-3 pb-4 text-primary">
            <ul class="space-y-2 py-1.5 font-medium">
                <li>
                    <a href="{{ url(route('dashboard-super-admin')) }}" title="Halaman beranda" class="group flex items-center rounded-lg p-2 hover:bg-gray-100 hover:text-gray-700">
                ...
                <li>
                    <a href="{{ url(route('achievement-super-admin')) }}" title="Halaman capaian kinerja" class="group flex items-center rounded-lg p-2 hover:bg-gray-100 hover:text-gray-700">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-5 w-5 transition duration-75" fill="currentColor">
                        ...
                        <span class="ms-3">Capaian Kinerja</span>
                    </a>
                </li>
            </ul>
            <ul class="space-y-2 py-1.5 font-medium">
                <li>
                    <a href="{{ url(route('rs-super-admin')) }}" title="Halaman rencana strategis" class="group flex items-center rounded-lg p-2 hover:bg-gray-100 hover:text-gray-700">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-5 w-5 transition duration-75" fill="currentColor">
                        ...
                        <span class="ms-3">Rencana Strategis</span>
                    </a>
                </li>
                <li>
                    <a href="{{ url(route('iku-super-admin')) }}" title="Halaman indikator kinerja utama" class="group flex items-center rounded-lg p-2 hover:bg-gray-100 hover:text-gray-700">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-5 w-5 transition duration-75" fill="currentColor">
                        ...
                        <span class="ms-3">Indikator Kinerja Utama</span>
                    </a>
                </li>
            </ul>
            <ul class="space-y-2 py-1.5 font-medium">
                <li>
                    <a href="{{ url(route('users-super-admin')) }}" title="Halaman pengguna" class="group flex items-center rounded-lg p-2 hover:bg-gray-100 hover:text-gray-700">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-5 w-5 transition duration-75" fill="currentColor">
                ...
                <li>
                    <a href="{{ url(route('organization-super-admin')) }}" title="Halaman organisasi" class="group flex items-center rounded-lg p-2 hover:bg-gray-100 hover:text-gray-700">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-5 w-5 transition duration-75" fill="currentColor">
                        ...
                        <span class="ms-3">Organisasi</span>
                    </a>
                </li>
            </ul>
            <ul class="space-y-2 py-1.5 font-medium">
