<div class="flex items-center gap-2 max-md:flex-wrap">
    @if (isset($previous) || isset($previousRoute))
        <a href="{{ url(isset($previous) ? route($previous) : $previousRoute) }}" title="Tombol kembali" class="rounded-lg p-1 text-primary hover:bg-gray-100 focus:ring-2 focus:ring-gray-200 sm:p-2">
