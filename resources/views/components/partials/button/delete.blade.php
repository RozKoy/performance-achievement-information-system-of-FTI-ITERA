<button type="button" title="Hapus" data-id="{{ $id }}" onclick="pushDeleteId(this)" data-modal-target="{{ $modal }}" data-modal-toggle="{{ $modal }}" data-body='{{ $data }}' class="rounded-full bg-red-500 p-0.5 text-white hover:bg-red-400">
