@php
    /**
     * @required @param link: route|string
     * @optional @param viewOnly: mixed
     */
@endphp

<a href="{{ url($link) }}" title="Kelola" class="{{ isset($viewOnly) ? 'pointer-events-none' : 'hover:bg-gray-400' }} rounded-full bg-gray-500 p-0.5 text-white">
