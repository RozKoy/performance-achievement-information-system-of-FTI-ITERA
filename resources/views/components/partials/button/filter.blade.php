<button type="button" title="Tombol filter" onclick="filterToggle()" class="ml-auto flex items-center gap-1 rounded-lg bg-orange-500 px-2 py-1.5 text-center text-xs text-white hover:bg-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-400 max-sm:w-fit sm:text-sm">
