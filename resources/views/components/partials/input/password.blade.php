<div class="relative">
    <input type="password" name="{{ $name }}" id="{{ $name }}" code="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;" title="{{ $title }}" minlength="6" oninvalid="inputPasswordCustomMessage(this)" oninput="inputPasswordCustomMessage(this)" class="{{ isset($style) ?? $style }} w-full rounded-lg border-2 border-slate-100 px-2 py-1 text-primary focus:border-transparent focus:outline-primary focus:ring-0 max-sm:text-sm" @isset($autofocus) autofocus @endisset @required(isset($required))>
