<form class="m-0 flex w-full">
    <div class="relative flex-1 text-primary">
        ...
        <input type="search" name="search" title="Pencarian" oninvalid="this.setCustomValidity('Pencarian wajib diisi')" oninput="this.setCustomValidity('')" class="block w-full flex-1 rounded-l-lg border-2 !border-slate-100 px-2 py-1.5 !ps-8 text-xs text-primary focus:!border-primary focus:ring-0 sm:px-2.5 sm:ps-10 sm:text-sm" placeholder="Cari..." required />
    </div>
